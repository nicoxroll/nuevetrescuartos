  ...
  return (
    ...
    >
      <motion.div style={{ y }} className="absolute inset-0 z-0 w-full h-full">
        ...
        />
        <div
          className={`absolute inset-0 bg-gradient-to-b from-transparent via-[#121212]/30 to-[#121212] transition-opacity duration-700 ${
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl">
        <div className="flex items-center justify-center mb-6 select-none animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <span className="text-[10rem] md:text-[18rem] font-pistilli leading-none text-white tracking-tighter drop-shadow-2xl">
            9
          </span>
          <div className="flex flex-col items-center justify-center ml-2 md:ml-6">
            <span className="text-5xl md:text-[7rem] font-pistilli leading-none text-white">
              3
            </span>
        ...
        <div className="flex justify-center">
          ...
          >
            <span className="text-xs uppercase tracking-[0.3em] font-industrial">
              Descender al andén
            </span>
